...
/// ===================== StaffShell (เฉพาะ bar ล่าง + เปลี่ยนแท็บแบบลื่น) =====================
class StaffBar extends StatefulWidget {
  ...
  @override
  State<StaffBar> createState() => _StaffShellState();
}

class _StaffShellState extends State<StaffBar> {
  int _currentIndex = 0;
            ...
            builder: (_, _) {
              ...
              return PageView.builder(
                ...
                itemBuilder: (context, index) {
                  // เอฟเฟกต์ระหว่างสลับหน้า (parallax + scale + fade)
      ...
      child: Center(
        child: AnimatedScale(
          ...
          child: Icon(
            icon,
            size: 24,
            color: active ? const Color(0xFFDD0303) : Colors.white.withValues(alpha:0.7),
          ),
        ),
      ),
    );
